package gui.com.rush;

/**
 * Uniform hexagonal grid cell's metrics utility class.
 * (Used for drawing the hex field on screen)
 * https://github.com/silverio/samples
...
public class HexGridCell {
    ...
    public int[] getCellPos(int i , int j) {
    	return new int[]{i * SIDE, HEIGHT * (2 * j + (i % 2)) / 2};
    }
